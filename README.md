...
3. [Tool: Train-test split for images to be used in a data generator function](https://github.com/Bixi81/Python-ml/blob/master/keras_test_train_split_images.py)
4. [Keras multi-output model using the functional API](https://github.com/Bixi81/Python-ml/blob/master/keras_multitarget_functionalAPI.py)
